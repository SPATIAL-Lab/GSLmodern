...
# Initialize plot
png("out/Fig2.png", 10, 5, "in", res = 600)
...
## Plot
par(mar = c(5, 5, 1, 1))
plot(lr$F14R, lr$d13Cc, xlim = c(0.65, 1), ylim = c(-5, 5),
...
points(R.DDL$F14R[R.DDL$Age.med > 1790], 
       R.DDL$d13Cc[R.DDL$Age.med > 1790],
       pch = 21, bg = "darkgoldenrod2", cex = 1.5)
points(R.DDQ$F14R[R.DDQ$Age.med > 1790], 
       R.DDQ$d13Cc[R.DDQ$Age.med > 1790],
       pch = 21, bg = "darkgoldenrod2", cex = 1.5)

points(R.DDL$F14R[R.DDL$Age.med > 1959], 
       R.DDL$d13Cc[R.DDL$Age.med > 1959],
       pch = 21, bg = "red3", cex = 1.5)
points(R.DDQ$F14R[R.DDQ$Age.med > 1959], 
       R.DDQ$d13Cc[R.DDQ$Age.med > 1959],
       pch = 21, bg = "red3", cex = 1.5)

d13Cc.atm = Cmod(1, tc)
d13Cc.org = Cmod(0, tc)
lines(c(0, 1), c(0, d13Cc.atm$d13Cc), lwd = 2)
Forg = 0.5
lines(c(0, 1), 
      c(0, d13Cc.org$d13Cc * Forg + d13Cc.atm$d13Cc * (1 - Forg)), lwd = 2)
